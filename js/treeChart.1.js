      ...
      selection.each(function scope() {
        ...
        function update(source) {
            ...
            nodeEnter.append("svg:text")
                ...
                //.attr("data-tooltip", "A test tooltip")
                ...
                //.on("mouseover", function(d){tooltip2.text(d.data); return tooltip2.style("visibility", "visible");})
            ...
            $(document).on('mouseover', 'text.data', popup('.custom.popup'));
