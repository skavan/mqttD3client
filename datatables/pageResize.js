...
PageResize.prototype = {
	_size: function ()
	{
		...
		var rowHeight = $( 'tr', settings.body ).eq(0).height()+1;
		var availableHeight = settings.host.height();
		console.log("starting available height/offset/rowHeight:" + availableHeight + "/" + offsetTop + "/" + rowHeight);
		...
		console.log("ending available height/row Height:" + availableHeight + "/" + rowHeight);
	},
